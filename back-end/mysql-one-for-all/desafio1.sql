DROP DATABASE IF EXISTS SpotifyClone;
  ...
  CREATE TABLE SpotifyClone.membership(
  ...
  INSERT INTO SpotifyClone.membership (membership_name, `value`)
  VALUES
    ('gratuito',0.00),
    ('familiar',7.99),
    ('universitário',5.99),
  ...
  INSERT INTO SpotifyClone.`user` (user_name, age, membership_id, `date`)
  VALUES
  ...
  INSERT INTO SpotifyClone.album (album_name, launch_year, artist_id)
  VALUES
    ('Renaissance', 2022, 1),
    ('Jazz', 1978, 2),
    ('Hot Space', 1982, 2),
  ...
  INSERT INTO SpotifyClone.music (music_name, duration, album_id, artist_id)
  VALUES
